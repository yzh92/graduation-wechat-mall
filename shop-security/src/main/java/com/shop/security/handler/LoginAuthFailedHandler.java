...
import com.shop.security.exception.BaseShopAuth2Exception;
...
public class LoginAuthFailedHandler implements AuthenticationFailureHandler {
    ...
    public void onAuthenticationFailure(HttpServletRequest request,
        ...
        if (!(exception instanceof BaseShopAuth2Exception)) {
            return;
        }

        BaseShopAuth2Exception auth2Exception = (BaseShopAuth2Exception) exception;
